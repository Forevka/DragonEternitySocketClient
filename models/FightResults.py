...
class FightResults:
    ...
    def from_dict(obj: Any) -> 'FightResults':
        ...
        dec_money = from_bool(obj.get("decMoney"))
        ...
        finish = from_bool(obj.get("finish"))
        honor = from_int(obj.get("honor"))
        honor2 = from_int(obj.get("honor2"))
        kill_cnt = from_int(obj.get("killCnt"))
        money = from_int(obj.get("money"))
        pvp = from_bool(obj.get("pvp"))
        team = from_int(obj.get("team"))
        winner_team = from_int(obj.get("winnerTeam"))
